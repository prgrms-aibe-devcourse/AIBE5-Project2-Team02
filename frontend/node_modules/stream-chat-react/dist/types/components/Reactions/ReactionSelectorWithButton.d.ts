 ...
 */
export declare const ReactionSelectorWithButton: ({ ReactionIcon, }: ReactionSelectorWithButtonProps) => import("react/jsx-runtime").JSX.Element;
export {};
//# sourceMappingURL=ReactionSelectorWithButton.d.ts.map