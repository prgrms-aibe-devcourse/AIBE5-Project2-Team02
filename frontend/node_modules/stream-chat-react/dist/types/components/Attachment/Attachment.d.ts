...
import type { AttachmentActionsDefaultFocusByType, AttachmentActionsProps } from './AttachmentActions';
...
export declare const ATTACHMENT_GROUPS_ORDER: readonly ["media", "giphy", "card", "geolocation", "file", "unsupported"];
 ...
 */
export declare const Attachment: (props: AttachmentProps) => import("react/jsx-runtime").JSX.Element;
